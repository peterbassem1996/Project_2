...
public class Date implements Comparable<Date> {
    ...
    public Date() {
        ...
        this.month = currentDate.get(Calendar.MONTH) + MONTH_VARIANCE;
     ...
     * @param year The year that is to be changed
     */
     ...
     * @param month The month that is to be changed
     */
     ...
     * @param day The day that is to be changed
     */
    ...
    public static void main(String[] args) {
    	Date day1 = new Date("1/30/2021");
    	Date day2 = new Date("2/1/2021");
    	Date day3 = new Date("2/20/2021");
    	Date day4 = new Date("Peter");
    	System.out.println(day2.compareTo(day3));
    	System.out.println(day2.compareTo(day1));
    	System.out.println(day2.compareTo(day2));
